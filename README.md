...
- If new project (not fork):
  - Copy [invictodesokupa.com project files](https://github.com/invictodesokupa/invictodesokupa.com)
...
- `README.md` ⏩ edit baseURL ("invictodesokupa.com") + delete steps bit by bit
- Design
...
- If Netlify
  - [`Domain Management / settings`](https://app.netlify.com/sites/invictodesokupa/settings/domain)
  - `Add custom domain`
  - `Check DNS configuration` Copy
  - Add `DNS Records` copied from Netlify to Domain gestor:
    - From: `invictodesokupa.com`
    ...
    - From: `www`
      DNS Record: `CNAME`
      To: `invictodesokupa.netlify.app.`
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/invictodesokupa/domains)
  ...
  - Add `DNS Records` copied from Cloudflare Pages to Domain gestor:
    - From: `invictodesokupa.com`
      DNS Record: `CNAME`
      To: `invictodesokupa.pages.dev`
    - From: `www`
      DNS Record: `CNAME`
      To: `invictodesokupa.pages.dev`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.invictodesokupa.com`
  - ...........................................................
...
- If Netlify Form
  ...
  - [`Netlify ⏩ Site ⏩ Forms ⏩ Form Notifications`](https://app.netlify.com/sites/invictodesokupa/settings/forms#form-notifications) ⏩ `Add notification ⏩ Email notification ⏩ Email to Notify`
    - `Email to notify` = Emails of collaborators that want receive submissions
    - `Custom email subject line` = `Formulario de contacto de invictodesokupa.com`
    - `Save`
  - Submissions: [`Netlify site ⏩ Forms`](https://app.netlify.com/sites/invictodesokupa/forms)
...
1. [Servicios invictodesokupa.com](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
